...
<a href="https://testuser-barrak.gitbook.io/linux-sysops-handbook" alt="Gitbook link"><img src="https://img.shields.io/badge/gitbook-link-success" /></a>
...
```shell
$ sudo usermod -G admins testuser
$ sudo usermod -aG staff testuser
```
...
```shell
$ ls -l
-rw-r--r--  1 testuser  staff  35149 Jan 30 17:20 LICENSE
```
